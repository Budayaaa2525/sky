...
<div class="list-group mt-4">
    ...
    <a href="?page=catatan_perjalanan" class="list-group-item <?php if($page=='catatan_perjalanan'){echo"active";} ?>">Catatan Perjalanan</a>
    <a href="?page=isi_data" class="list-group-item <?php if($page=='isi_data'){echo"active";} ?>">Isi Data</a>
